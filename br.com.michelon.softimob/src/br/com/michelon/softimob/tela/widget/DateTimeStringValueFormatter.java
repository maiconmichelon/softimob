...
public class DateTimeStringValueFormatter extends StringValueFormatter{

	public DateTimeStringValueFormatter() {
		super(new Format() {
			...
			public Object parseObject(String source, ParsePosition pos) {
				try {
					return FormatterHelper.getSimpleDateFormatHorasMinutos().parse(source);
