 ...
 ******************************************************************************/
package br.com.michelon.softimob.aplicacao.map;
...
public class GMap extends Composite {
	...
	private static final String[] AVAILABLE_TYPES = new String[] { "ROADMAP", "SATELLITE", "HYBRID", "TERRAIN" };
	 ...
	 * 
	 * @param type
	 *            the map type, one of {@link #TYPE_HYBRID},
	 *            {@link #TYPE_ROADMAP}, {@link #TYPE_SATELLITE}, or
	 *            {@link #TYPE_TERRAIN}
	 */
	...
	/**
	 * Sets the location of the map to the best result that matching the
	 * address. There will be some delay while the geocoder is queried.
	 */
