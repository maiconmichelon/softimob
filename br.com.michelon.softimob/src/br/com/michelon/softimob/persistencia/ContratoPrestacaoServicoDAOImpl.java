...
public class ContratoPrestacaoServicoDAOImpl {
	...
	public List<ContratoPrestacaoServico> findByTipo(TipoContrato tipo){
		TypedQuery<ContratoPrestacaoServico> query = em.createQuery("SELECT c FROM ContratoPrestacaoServico c WHERE c.tipo = :tipo1 OR c.tipo =:tipo2", ContratoPrestacaoServico.class);
